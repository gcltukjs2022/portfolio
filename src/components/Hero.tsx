  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[20%] xl:top-[10%] 2xl:top-[20%] w-full h-full px-6 lg:p-24 flex flex-col lg:items-center gap-y-6 lg:gap-y-12 text-white">
        ...
        <button
          className="bg-transparent border-2 rounded-lg w-[80%] text-white py-4 mt-12 xl:mt-4 lg:px-12 lg:py-4 font-semibold"
          onClick={scrollToProjects}
        >
          PROJECTS
        </button>
        <div className="hidden xl:block absolute top-[70%] left-1/2 transform -translate-x-1/2">
